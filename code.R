pacman::p_load(
  ...
  grid, forestploter, tidyverse, forcats
)
...
# Recode(df1$status)
df1$status <- Recode(df1$status,
  "IVA Lateral Spine scan completed, all vertebra are valid::1",
  "IVA Lateral Spine scan completed, but one or more vertebrae are invalid::0",
  "IVA Lateral Spine not scanned, other reason::0",
  "IVA Lateral Spine not scanned, pregnancy::0",
  "IVA Lateral Spine not scanned, weight > 450 lbs::0",
  "NA::0",
  to.numeric = FALSE
)
# Recode(df1$Lstatus)
df1$Lstatus <- Recode(df1$Lstatus,
  "IVA Lateral Spine scan completed, L1-L4 are valid::1",
  "IVA Lateral Spine scan completed, among L1-L4 one or more vertebrae are invalid::0",
  "IVA Lateral Spine not scanned, other reason::0",
  "IVA Lateral Spine not scanned, pregnancy::0",
  "IVA Lateral Spine not scanned, weight > 450 lbs::0",
  "NA::0",
...
df2 <- select_row(df2, df2$status == 1)
...
ggsave("Figure 3.png", plot = lassototal, dpi = 600, width = 10, height = 6.18, units = "in")
ggsave("Figure 3.pdf", plot = lassototal, dpi = 600, width = 10, height = 6.18, units = "in")
ggsave("Figure 3.tiff", plot = lassototal, dpi = 600, width = 10, height = 6.18, units = "in")
...
ggsave("Figure 4.png", plot = rftotal, dpi = 600, width = 12, height = 8, units = "in")
ggsave("Figure 4.tiff", plot = rftotal, dpi = 600, width = 12, height = 8, units = "in")
ggsave("Figure 4.pdf", plot = rftotal, dpi = 600, width = 12, height = 8, units = "in")
...
(p12 <- ggplot(data = roc12, aes(FP, TP, color = Model)) +
  ...
  annotate("text",
    x = 0.8, y = 0.25, size = 3, family = "sans",
    label = paste0(
      "AUC at 12-month: ",
  ...
  annotate("text",
    x = 0.8, y = 0.15, size = 3, family = "sans",
    label = paste0(
      "AUC at 12-month:",
  ...
  annotate("text",
    x = 0.8, y = 0.05, size = 3, family = "sans",
    label = paste0(
      "P-value:",
...
ggsave("Figure 5.png", plot = roctotal, dpi = 600, width = 10, height = 6.18, units = "in")
ggsave("Figure 5.tiff", plot = roctotal, dpi = 600, width = 10, height = 6.18, units = "in")
ggsave("Figure 5.pdf", plot = roctotal, dpi = 600, width = 10, height = 6.18, units = "in")
...
fore <- fore |> dplyr::rename("Standard Error" = "se.coef.")
fore <- fore |> dplyr::rename("Robust Standard Error" = "robust.se")
...
ggsave("Figure 6.png", plot = pfore1, dpi = 600, width = 12, height = 7.4, units = "in")
ggsave("Figure 6.tiff", plot = pfore1, dpi = 600, width = 12, height = 7.4, units = "in")
ggsave("Figure 6.pdf", plot = pfore1, dpi = 600, width = 12, height = 7.4, units = "in")
